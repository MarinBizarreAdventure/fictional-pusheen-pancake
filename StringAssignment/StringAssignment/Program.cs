...
namespace StringAssignment
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Time after 5 min: {dateTime}");


            StringAssigment originalText = new StringAssigment(text);

            //- Display the word count of this string
            Console.WriteLine($"Word Count: {originalText.WordCount}");
            //- Display the sentence count of this string
            Console.WriteLine($"Sentence Count: {originalText.SentenceCount}");
            //- Display how often the word "encapsulation" appears in this string
            Console.WriteLine($"Number of occurencies of word \"encapsulation\": {originalText.FindSubstingOccurencies("encapsulation")}");
            //- Display this string in reverse, without using any C# language feature. (Create your own algorith)
            Console.WriteLine($"Reversed String: {originalText.Reverse}");
            //- In the given string, replace all occurances of "object-oriented programming" with "OOP" and display the new string
            Console.WriteLine($"Replaced String: {originalText.ReplaceSubsting("object-oriented programming", "OOP")}");
